...
MoveIntent::MoveIntent(unsigned int robot_id, const Point &dest, const Angle &final_angle,
                       double final_speed, unsigned int priority, bool enable_dribbler, bool enable_autokick)
    : MovePrimitive(robot_id, dest, final_angle, final_speed, enable_dribbler, enable_autokick), Intent(priority)
{
}
